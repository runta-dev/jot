...
const rules={agent:new Set(),browser:new Set(['patchright']), 'jev-core':new Set(['jsrealb']),ui:new Set(['react','react-dom/client','lucide-react','@jot/agent','@jot/browser/types','@jot/browser/address'])};
